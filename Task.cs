...
namespace TeamNorthStar_TaskTrackerApp.Models
{
        ...
        public class PersonalTask : Task
        {
            ...
            {
                return $"{Title} (Personal) - {Description}, Due: {DueDate.ToShortDateString()}, Priority: {Priority}, Completed: {IsCompleted}";
            }
        }
        ...
        public class WorkTask : Task
        {
            ...
            public override string GetTaskDetails()
            {
                return $"{Title} (Work) - {Description}, Due: {DueDate.ToShortDateString()}, Assigned To: {AssignedTo}, Completed: {IsCompleted}";
            }
        }
